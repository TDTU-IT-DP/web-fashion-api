...
1.   **Singleton**
  ...
  >>>1.	Đảm bảo một class chỉ có duy nhất một instance.
  >>>2.	Do instance có khả năng sử dụng trong suốt chương trình, nên Singleton cũng cung cấp một điểm truy cập toàn tục đến instance đó.
...
>4. *Các cách Implement Singleton Pattern*
...
>3.*Ưu và nhược điểm của Adapter Pattern*
>>**Ưu điểm**
...
1. **Ứng dụng các pattern (Lý do chọn pattern)**
>>1.*Singleton*
